...
# Определяем имя функции которая была запущена.  Необходимо для аналитики - разметка событий
def whoami():
...
def welcome_message(event):
    tts = "<speaker audio=\"dialogs-upload/79d52816-5120-448f-b623-951682431dc3/a8246cb2-b563-49fe-9b27-81876a88a2be.opus\"> Добро пожаловать, тут я могу помочь вам найти для себя новую профессию, расскажу о самых интересных и востребованных IT профессий, Вы знаете какое направление вас интересует?"
...
def test_q6(event):
    ...
    tts = (
        'Аналитик sil<[1000]>. Аналитик - это специалист, который занимается выявлением '
        'бизнес-проблем, выяснением потребностей заинтересованных сторон, обоснованием '
        'решений и обеспечением проведения изменений в организации. Вам нравится ?'
        )
    return make_response(
        text='',
        tts=tts,
...
def test_q4_1(event):
    tts =  "<speaker audio=\"alice-sounds-human-kids-1.opus\"> А сейчас sil <[300]> давайте перенесемся в Ваше детство<speaker audio=\"dialogs-upload/79d52816-5120-448f-b623-951682431dc3/83b9f928-5ec5-441a-bc17-657a746e967e.opus\"> Вы  любили  разбирать  и ломать игрушки в детстве?"
